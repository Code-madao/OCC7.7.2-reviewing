...
//! The Projection class provides conical and cylindrical projections of Edge
//! or Wire on a Shape from TopoDS. The result will be a Edge or Wire from TopoDS.
...
protected:
private:
  //! Performs section of theShape by theTool and stores result in the fields.
