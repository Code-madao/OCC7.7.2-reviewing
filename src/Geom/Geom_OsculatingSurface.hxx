...
public:
  ...
  //! detects if the surface has punctual U or V isoparametric curve along on the bounds of
  //! the surface relatively to the tolerance Tol and Builds the corresponding osculating surfaces.
