...
protected:
  ...
  Standard_EXPORT Standard_Integer CheckCoincidence(const Standard_Real aT11, const Standard_Real aT12,
                                                    const Standard_Real aT21, const Standard_Real aT22,
  ...
  Standard_EXPORT Standard_Boolean IsIntersection(const Standard_Real aT11, const Standard_Real aT12,
                                                  const Standard_Real aT21, const Standard_Real aT22);
  ...
  //! if the edges are coincided really. default be false.
