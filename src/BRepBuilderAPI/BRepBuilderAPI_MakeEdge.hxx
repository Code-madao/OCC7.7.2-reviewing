...
//!
//! Make an edge on the curve between parameters p1 and p2. if p2 < p1
//! the edge will be REVERSED. If p1 or p2 is infinite the curve will be open
//! in that direction. Vertices are created for finite values of p1 and p2.
//!
